...
<header role="banner">
	<h2 class="entry-title"><?php esc_html_e( 'Nothing Found', 'multipurpose-photography' ); ?></h2>
</header>
...
<?php else : ?>
	...
	<div class="read-moresec">
		<a href="<?php echo esc_url( home_url() ); ?>" class="button"><?php esc_html_e( 'Return to the home page', 'multipurpose-photography' ); ?><span class="screen-reader-text"><?php esc_html_e('Return to the home page','multipurpose-photography'); ?></span></a>
	</div>
<?php endif; ?>